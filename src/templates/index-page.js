                ...
                <div className="content">
                  ...
                  <div className="column is-6">
                      <section className="section">
                        ...
                        <p>  
                          バトル開始時に編成したロスターのクルセイドポイントを比較し、少ない方のプレイヤーに差分の半分を（切り捨て）CPとして与えます。８以上のクルセイドポイントの差は出来るだけ避けましょう。
                        </p>  
                      </section>
                    </div>
                      ...
                      <section className="section">
                        ...
                        <ol>
                          <li>
                            ...
                            <p className="is-italic">例えば、ミッションパック「ビヨンドヴェール」からミッションを選んでゲームをした場合、各プレイヤーは調査ポイントを取得しても良い。ただし、ミッションパック「カタストロフ」からミッションを選んでも3人以上でのゲームはできません。</p>
                          </li>
                          <li>
                          ...
                          <li>
                            キャンペーンフェーズ終了時に各戦域の伝説的会戦を選び、特に厳しい戦に挑戦できることがあります。志願者は「ヴィジルスの孤立」54-59ページを参照するか、直接キャンペーンマスターにお尋ねください。
                          </li>
                        </ol>
                        <p className="is-underlined">片方のプレイヤーが不利になりそうな場合は、攻撃・防御側、或いは先攻・後攻をそのプレイヤーから選びましょう。</p> 
                      </section>
                    </div>
                    <div className="column is-6">
                      <section className="section">
                    ...
                    <div className="column is-6">
                      <section className="section">
                        <h3>思惑の選択</h3>
                        コンバットパトロールのゲームは２つ、インカージョンのゲームは３つというふうに、<span className="is-underlined">思惑は一つ多く選択しても良い</span>です。                      
                        </section>
                    </div>
                    <div className="column is-6">
                      <section className="section">
                        ...
                        <h3>ポイント計算と負傷ロール</h3>
                        <p>
                        必ずしも第５ラウンドまでゲーム進めなくても大丈夫です。時間が無くなりそうな時はキリの良いところで終了し、<span className="is-underlined">できるだけ対戦相手の前で勝利ポイント計算、負傷ロールとクルセイドカードの処理をお願いします</span>。ゲーム終了時に、以下のように勝利ポイントを追加しても良いです。
                        </p>
                        <ul>
                          <li>
                          時間通り到着した（VP+5）                           
                    ...
                    <div className="column is-6">
                      <section className="section">
                        <p>採点したら、選択した戦域と勝敗の結果をストアマネージャー或いはキャンペーンマスターまでお知らせください。HP、ディスコード
                          そしてウォーハンマーストア神保町に掲示しているヴィジルスの星域図に反映させます。キャンペーンが終わるとき、ヴィジルスを掌握しているのは帝国側でしょうか、それとも混沌側でしょうか？そしてどのような最高の物語が紡ぎあげるのでしょう？</p>
                        <h3>一番大事なルール</h3>
